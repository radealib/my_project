            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h1 class="card-title">Data Sasaran Kegiatan <?php echo $_SESSION['tahun']; ?></h1>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Tambah Sasaran Kegiatan <?= $_SESSION['tahun'] ?></h4>
            ...
            <form method="get" action="tambah/tambah_sasaran_kegiatan.php">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" placeholder="" name="sasaran" required autofocus>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label" name="ind_kinerja">Indikator Kinerja</label>
                        <textarea class="form-control" input type="text" placeholder="" name="ind_kinerja" rows="3" required></textarea>
                    </div>
                    <label for="exampleFormControlInput1" class="form-label" name="target">Target (%)</label>
                    <div class="input-group mb-3">
                        <input type="number" class="form-control" name="target" aria-label="target" aria-describedby="basic-addon1" max="100" min="0">
